...
class AgGridTable extends React.Component {
  ...
  render() {
    ...
    let baseClasses = 'SortableItem rfb-item sdasd';
    if (this.props.data.pageBreakBefore) { baseClasses += ' alwaysbreak'; }
  ...
  render() {
    ...
    return (
      <div  className={baseClasses}>
        <ComponentHeader {...this.props} />
        <Button type='primary' className={this.props.data.className}>{this.props.data.content}</Button>
      </div>
    );
  }
}
...
class TextInput extends React.Component {
  ...
  render() {
    ...
    console.log(this.props , "all props of TextInput");
    const style = {
      display: "flex",
      alignItems: "center",
...
FormElements.CustomButton = CustomButton;
FormElements.AgGridTable = AgGridTable;
