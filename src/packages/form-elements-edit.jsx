...
import ClassSelector from './editor-component/ClassSelector';
import { updateElement as updateElementRedux } from '../appRedux/slices/elementSlice';
...
class FormElementsEdit extends React.Component {
  ...
  editElementProp(elemProperty, targProperty, e) {
    ...
    // const this_element =JSON.parse(JSON.stringify( this.state.element));
    // this_element[elemProperty] = e.target[targProperty];
    console.log(this, elemProperty, targProperty, e);
 
    const this_element = JSON.parse(JSON.stringify(this.props.element)) || {};
 
    if (this.props.element.elementType === "CustomButton") {
      this_element["apiPayload"] = JSON.parse(JSON.stringify({ data: {} }));
    }
    this.props.dispatch(
      updateElementRedux({
        elementConfig: {
  ...
  onEditorStateChange(index, property, editorContent) {
    ...
    this.props.dispatch(
      updateElementRedux({
        elementConfig: { ...this_element, [property]: html },
        elementId: this_element?.id,
      })
    );
  ...
  updateElement() {
    const this_element = this.props.element;
    console.log(">>>>>>>>>>>>>this_element>>>>>", this.state);
    this.props.dispatch(
      updateElementRedux({
        elementConfig: this_element,
        elementId: this_element?.id,
      })
    );
  ...
  updateElementConfig = (elementObj) => {
    const this_element = elementObj || this.props.element;
    this.props.dispatch(
      updateElementRedux({
        elementConfig: this_element,
        elementId: this_element?.id,
  ...
  onValueChange = ({ field, value }) => {
    ...
    this.props.dispatch(
      updateElementRedux({
        elementConfig: { ...this_element, [field]: value },
        elementId: this_element?.id,
      })
    );
  };
    ...
    return (
      <div>
        ...
        {this.props.element.hasOwnProperty("field_name") && (
          <div className="form-group">
            <label className="control-label">Value field name</label>
        ...
        <ClassSelector
          value={this.props.element.className}
          setValue={(value) => {
            const this_element = this.props.element;
            this.props.dispatch(
              updateElementRedux({
                elementConfig: { ...this_element, className: value },
                elementId: this_element?.id,
              })
            );
          }}
        ...
        {this.props.element.hasOwnProperty("label") && (
          <div className="form-group">
            ...
            {(this.state.element.element === "RadioButtons" ||
              this.state.element.element === "Checkboxes")|| this.state.element.element==="Tabbed"&&
              canHaveDisplayHorizontal && (
                <div className="custom-control custom-checkbox">
                  <input
        ...
        {this.props.element.hasOwnProperty("onClick") && (
          <div>
            <div className="form-group">
              <label className="control-label" htmlFor="srcInput">
                <IntlMessages id="onClick" />:
              </label>
              <select
                id="fileSelect"
                className="form-control"
              ...
              >
                <option value="apiCall" key="apiCall">
                  Api call
                </option>
                ;
                <option value="redirect" key="redirect">
                  Redirect
                </option>
                ;
              </select>
              <br />
              {this.state.btnOnClick === "apiCall" ? (
                <div className="container buttonConfigOnClick">
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <select
                        id="fileSelect"
                        className="form-control"
                        defaultValue={this.props.element.apiMethod}
                        onBlur={this.updateElement.bind(this)}
                        onChange={this.editElementProp.bind(
                          this,
                          "apiMethod",
                    ...
                    <div className="col-lg-6">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        defaultValue={this.props.element.apiURL}
                        onBlur={this.updateElement.bind(this)}
                        onChange={this.editElementProp.bind(
                          this,
                          "apiURL",
                    ...
                    <div className="col-lg-6">
                      ...
                      <textarea
                        className="form-control"
                        defaultValue={this.props.element.apiPayload}
                        onBlur={this.updateElement.bind(this)}
                        onChange={this.editElementProp.bind(
                          this,
                          "apiPayload",
                    ...
                    <div className="col-lg-6">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        defaultValue={this.props.element.workflowId}
                        onBlur={this.updateElement.bind(this)}
                        onChange={this.editElementProp.bind(
                          this,
                          "workflowId",
                ...
                <input
                  ...
                  type="text"
                  className="form-control"
                  defaultValue={this.props.element.redirect}
                  onBlur={this.updateElement.bind(this)}
                  onChange={this.editElementProp.bind(
                    this,
                    "redirect",
        ...
        {this.props.element.hasOwnProperty("options") && (
          <DynamicOptionList
            ...
            data={JSON.parse(JSON.stringify(this.props.element))}
            updateElement={this.updateElementConfig}
...
const mapStateToProps = (state, ownProps) => ({
  element: state.elements?.elementObjects?.[ownProps?.element?.id],
});
 
export default connect(mapStateToProps, null)(FormElementsEdit);